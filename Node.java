...
public abstract class Node{
	...
	/**
       ...
       @return a reference which refers to the parent node, or null if this node is the root
	 */
	...
	public void delete (int i){
		...
		if (this.combinable(next)) {
			...
			if (prev.combinable(this)) {
				prev.combinable(this);
			}
			else {
				this.redistribute();
			}
